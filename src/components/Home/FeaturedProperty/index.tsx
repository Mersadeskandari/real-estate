        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col gap-10">
            ...
            <p className="text-base text-dark/50 dark:text-white/50">
                زندگی لوکس را در ویلای لوکس و مدرن واقع در خیابان آرورا جنوبی شماره ۲۰، میامی تجربه کنید. این خانه هوشمند ۵۶۰ فوت مربعی با قیمت ۱,۶۵۰,۵۰۰ دلار، دارای ۴ اتاق خواب، ۳ حمام و فضای نشیمن بزرگ است. از بهره‌وری انرژی، نور طبیعی، سیستم‌های امنیتی، فضاهای باز و ۲ فضای بار - مناسب برای ۸+ مهمان - لذت ببرید. ساخته شده در سال ۲۰۲۵.
            </p>
